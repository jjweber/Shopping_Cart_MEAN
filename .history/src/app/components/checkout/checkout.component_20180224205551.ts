...
export class CheckoutComponent implements AfterViewInit, OnDestroy  {
  ...
  async onSubmit(form: NgForm) {
    ...
    this.savedProduct.imagePath = (<HTMLInputElement>document.getElementById('name')).value;
    this.savedProduct.imagePath = (<HTMLInputElement>document.getElementById('address')).value;
