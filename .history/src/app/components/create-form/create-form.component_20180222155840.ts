...
export class CreateFormComponent implements OnInit {
  ...
  SaveProduct(product: Product) {
    console.log("Click!!");
    this.savedProduct.imgPath = (<HTMLInputElement>document.getElementById('namefield')).value;
    this.savedProduct.title = (<HTMLInputElement>document.getElementById('usernamefield')).value;
    this.savedProduct.description = (<HTMLInputElement>document.getElementById('emailfield')).value;
    this.savedProduct.price = (<HTMLInputElement>document.getElementById('passwordfield')).value;

    // Pushing the selectedVideo to my videoStore array.
    console.log('Pushing up saved video of: ', this.savedProduct);
