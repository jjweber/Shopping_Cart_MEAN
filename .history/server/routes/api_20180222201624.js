...
router.post('/saveToCart', function(req, res) {
    ...
    newCartItem.imageUrl = req.body.imageUrl,
    newCartItem.videoUrl = req.body.videoUrl,
    newCartItem.publishedAt = req.body.publishedAt
    newCartItem.save(function(err, insertedVideo) {
        if(err) {
